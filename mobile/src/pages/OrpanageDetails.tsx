...
export default function OrphanageDetails() {
  ...
  // isso força o entendimento do typescript
  ...
  // [params.id] é uma dependencia, recomendado usar.
  if(!orphanage){
    return (
  ...
  function handleOpenGooleMapRoutes(){
  ...
  <Text style={styles.description}>{orphanage.about}</Text>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleOpenGooleMapRoutes} style={styles.routesContainer}>
